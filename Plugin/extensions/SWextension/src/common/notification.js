 ...
 *
 *  */
var nTypesMessage={0:{name:"DEFAULT",iconClass:"fa fa-normal fa-bell"},10:{name:"USER_LIKED_ITEM",iconClass:"fa fa-normal fa-thumbs-up"},11:{name:"USER_LIKED_SHARE",iconClass:"fa fa-normal fa-thumbs-up"},15:{name:"USER_SHARED",iconClass:"fa fa-normal fa-user"},20:{name:"USER_FOLLOW",iconClass:"fa fa-normal fa-user"},25:{name:"USER_FOLLOWED_ITEM",iconClass:"fa fa-normal fa-heart"},30:{name:"FOLLOWED_USER_LIKED",iconClass:"fa fa-normal fa-user"},35:{name:"FOLLOWED_USER_ADDED",iconClass:"fa fa-normal fa-user"},40:{name:"FOLLOWED_CAT_ADDED",iconClass:"fa fa-normal fa-heart"},60:{name:"NEW_COMMENT",iconClass:"fa fa-normal fa-comment"},61:{name:"NEW_COMMENT_ITEM",iconClass:"fa fa-normal fa-comment"},65:{name:"NEW_REPLY_ACTION",iconClass:"fa fa-normal fa-comment"},66:{name:"NEW_REPLY_NODE",iconClass:"fa fa-normal fa-comment"},68:{name:"NEW_USER_COMMENT",iconClass:"fa fa-normal fa-comment"},70:{name:"ACTION_FINISHED",iconClass:"fa fa-normal fa-pencil"},75:{name:"NEW_ACTION_ITEM",iconClass:"fa fa-normal fa-pencil"},76:{name:"NEW_ACTION_FOLLOWED_ITEM",iconClass:"fa fa-normal fa-pencil"},120:{name:"USER_SHARE",iconClass:"fa fa-normal fa-user"},130:{name:"INVITE_ACCEPTED",iconClass:"fa fa-normal fa-user"},150:{name:"LEVEL_UP",iconClass:"fa fa-normal fa-beer"},151:{name:"LEVEL_DOWN",iconClass:"fa fa-normal fa-level-down"},152:{name:"LEVEL_UP_REENTER",iconClass:"fa fa-normal fa-beer"},155:{name:"SYSTEM_MESSAGE",iconClass:"fa fa-normal fa-exclamation-circle"},200:{name:"OPEN_COMPLAINTS",iconClass:"fa fa-normal fa-exclamation-triangle"},250:{name:"MOD_ACTION",iconClass:"fa fa-normal fa-exclamation-triangle"},275:{name:"COMPLAIN_COMPLETE",iconClass:"fa fa-normal fa-exclamation-triangle"}};
